function getContentWidth (elem) {
    ...
    var styles = getComputedStyle(element[1])
...
function text_cloud(data, id) {
    ...
    //        .style("fill", (i) => fill(i))
            .style("fill", function(d,i) { return colores_BuGn(i); })
